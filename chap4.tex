...
less efficient execution environments to be implemented.

Figure \ref{spectrum_insn} shows where the different strategies for translating
high level code to native machine code lie on the spectrum.
