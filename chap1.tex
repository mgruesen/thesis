...
problem domain with respect to low level virtualization of network interfaces and high level language translation to a native instruction set architecture 
(ISA). 
