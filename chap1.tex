...
device. In the following paragraphs, a brief description of each chapter
highlights the main research topics pursued throughout the development of
this project.

Related works are contained in the Chapter \ref{related}, detailing some of the
more mature research efforts in the domain of SDN.
...
platforms and frameworks is also covered.
