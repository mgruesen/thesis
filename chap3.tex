...
exist for Linux and DPDK backends as references for design and integration
purposes. ODP allows for different backends in order to support a broader class
...
\begin{figure}[h!]
  ...
  \end{subfigure}
  \caption{ODP can use a variety of backends to create different architectures.}
